...
import (
	...
	migrate "github.com/Max-Gabriel-Susman/bestir-matchmaking-service/db"
...
func TestMain(m *testing.M) {
	...
	// exponential backoff-retry, because the match in the container might not be ready to accept connections yet
